    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/vehicleTypes/list").permitAll()
                        .requestMatchers(HttpMethod.GET, "/vehicleTypes/getById/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/planTypes/list").permitAll()
                        .requestMatchers(HttpMethod.GET, "/planTypes/getById/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/segments/list").permitAll()
                        .requestMatchers(HttpMethod.GET, "/segments/getById/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/salesConfig").permitAll()
                        .requestMatchers(HttpMethod.GET, "/offerColumnConfig/list").permitAll()
